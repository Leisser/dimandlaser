...
import 'package:dimand/pages/picloads/commerpic.dart';
...
class _DimpostState extends State<Commer> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cFurnish, cRegion, cNegotiate, cType, cParking;
  bool _load = false;
  String _bolt = '';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cFurnish != null && _bolt != null && cType != null && cParking != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new CommerPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Office', 'Shop', 'Hotel', 'Warehouse', 'Factory', 'Filling Station',
                          'Mall', 'School', 'Tank Farm']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
