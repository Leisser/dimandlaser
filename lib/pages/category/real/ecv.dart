...
import 'package:dimand/pages/picloads/ecvpic.dart';


class Ecv extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<Ecv> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Event Centers & Venues';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new EcvPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Ballroom', 'Confrence Center', 'Club Hall', 'Gallery', 'Gardens', 'Marquee', 'Meeting Room', 'Multipurpose Hall',
