...
import 'package:dimand/pages/picloads/landpic.dart';
...
class _DimpostState extends State<Land> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cSquareM, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cSquareM != null && _bolt != null && cType != null) {
      ...
      await prefs.setString('cSquareM',cSquareM);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new LandPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Commercial Land', 'Industrial Land', 'Mixed-Use Land', 'Residential Land']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
