...
import 'package:dimand/pages/picloads/otherpic.dart';
...
class _DimpostState extends State<Other> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Other Animals';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new OtherPic()),
    );
