...
import 'package:dimand/pages/picloads/reptilepic.dart';
...
class _DimpostState extends State<Reptiles> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new ReptilePic()),
    );
