...
import 'package:dimand/pages/picloads/birdspic.dart';
...
class _DimpostState extends State<Birds> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BirdPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Canary', 'Crow', 'Eagle', 'Falcon', 'Finch', 'Ostrich',
                          'Owl', 'Pigeon', 'Parrot', 'Peacock', 'Sparrow', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
