...
import 'package:dimand/pages/picloads/electeqippic.dart';


class ElectEquip extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<ElectEquip> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Electrical Equipment';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new ElectEquipPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Cable Reels', 'Electrical Cables', 'Generators', 'Inverter Batteries', 'Plate Compactors',
                          'PLC trainers', 'Power Inverters', 'Soundproof Generators', 'Stabilizers',
