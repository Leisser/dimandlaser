...
import 'package:dimand/pages/picloads/solarpic.dart';
...
class _DimpostState extends State<Solar> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Solar Energy';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new SolarPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Charge Controllers', 'Deep Cycle Batteries', 'Solar Energy Systems', 'Solar Fans', 'Solar Lights',
                          'Solar Panels', 'Solar Water Heaters', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
