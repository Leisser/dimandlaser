...
import 'package:dimand/pages/picloads/doorpic.dart';
...
class _DimpostState extends State<Door> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cOpenType, cRegion, cNegotiate, cType, cMaterial;
  bool _load = false;
  String _bolt = '';
  String category = 'Repair & Construction';
  String subcategory = 'Doors';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cOpenType != null && _bolt != null && cType != null && cMaterial != null) {
      ...
      await prefs.setString('cOpenType',cOpenType);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new DoorPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Front Door', 'Double Door', 'Garage Door', 'Gates', 'Patio Door', 'Room Door',
                          'Sliding Door', 'Security Door']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Open Type'),
                          value: cOpenType,
                          items: <String>['Folding', 'Hinged', 'Rotating', 'Sliding']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose Material'),
                          value: cMaterial,
                          items: <String>['Aluminium', 'Composite', 'Glass', 'Stainless Steel', 'Wood']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
