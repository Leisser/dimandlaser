...
import 'package:dimand/pages/picloads/handpic.dart';
...
class _DimpostState extends State<Hand> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new HandPic()),
    );
