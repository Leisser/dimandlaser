...
import 'package:dimand/pages/picloads/otherrpic.dart';


class OtherR extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<OtherR> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cRegion, cNegotiate;
  bool _load = false;
  String _bolt = '';
  String category = 'Repair & Construction';
  String subcategory = 'Other Repair & Construction Items';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && _bolt != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new OtherRPic()),
    );
