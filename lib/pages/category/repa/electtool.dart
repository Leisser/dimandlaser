...
import 'package:dimand/pages/picloads/electtoolpic.dart';


class ElectTool extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<ElectTool> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Electrical Tools';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new ElectToolPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Air Blowers', 'Angle Grinders', 'Chainsaws', 'Changeover Switches', 'Concrete Cutter Machines',
                          'Cords', 'Drills', 'Dryer Blowers', 'Electrical Sockets',
                          'Glue Guns', 'Jack Hammers', 'Knife Switch', 'Light Switches', 'Power Trawel Machines', 'Road cutters',
                          'Rotary Hammers',  'Tile cutters', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
