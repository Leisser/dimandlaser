...
import 'package:dimand/pages/picloads/windowpic.dart';
...
class _DimpostState extends State<Window> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cShape, cRegion, cNegotiate, cType, cMaterial;
  bool _load = false;
  String _bolt = '';
  String category = 'Repair & Construction';
  String subcategory = 'Windows';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cShape != null && _bolt != null && cType != null && cMaterial != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new WindowPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Select Glass Type'),
                          value: cType,
                          items: <String>['Armoured', 'Tempered', 'Standard']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cShape,
                          items: <String>['Circle', 'Eyebrow', 'Half Circle', 'Pentagone', 'Rectangle', 'Square', 'Triangle']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMaterial,
                          items: <String>['Aluminium', 'Fiberglass', 'Stainless Steel', 'Vinyl', 'Wood']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
