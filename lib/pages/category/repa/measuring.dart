...
import 'package:dimand/pages/picloads/measuringpic.dart';
...
class _DimpostState extends State<Measuring> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Measuring & Layout Tools';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new MeasuringPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Auto Level', 'Battery Tester', 'Cable Tracker', 'Caliper', 'Digital Multimeter', 'Distance Meter',
                          'Field Tester', 'Float Switch', 'Measuring Wheel', 'Meter', 'PH Meter', 'Sound Level Meter', 'Tape Measure', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
