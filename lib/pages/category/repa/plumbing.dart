...
import 'package:dimand/pages/picloads/plumbingpic.dart';
...
class _DimpostState extends State<Plumbing> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Plumbing & Water Supply';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new PlumbingPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Dewatering Pumps', 'Drainage', 'Drainage Pumps', 'Faucets', 'Fountain Pumps', 'Gutters', 'Hoses',
                          'Jacuzzi', 'Sanitary Wares', 'Sewage Pump', 'Shower Cubicles', 'Shower Doors', 'Shower Heads', 'Shower Mixers', 'Shower Parts',
                          'Shower Trays', 'Submersable Pumps', 'Toilet Seats', 'Urinals', 'Wash Hand Basins', 'Water Closet', 'Water Pumps', 'Water Taps', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
