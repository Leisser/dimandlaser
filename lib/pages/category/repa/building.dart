...
import 'package:dimand/pages/picloads/buildingpic.dart';
...
class _DimpostState extends State<Building> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Building Materials';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BuildingPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Bathtubs', 'Blocks', 'Bricks', 'Carports', 'Ceiling', 'Cement', 'Chippings', 'Concrete Stamps', 'Doors',
                          'Flooring Materials', 'Faucets', 'Gates', 'Granite', 'Gutters', 'Handrails', 'Insulation Blankets',  'Jacuzi', 'Locks',
                          'Paints', 'Paving', 'Pillars', 'Pipes & Fittings', 'Plasters', 'Rods', 'Roofing Materials', 'Rubber', 'Sand', 'Sanitary Wares',
                          'Shawer Doors', 'Shower Heads', 'Shower Mixers', 'Shower Parts', 'Shower Trays',  'Sinks', 'Slabs', 'Tarpaulins', 'Toilet Seats',
                          'Urinals', 'Wash Hand Basins', 'Water Closets', 'Water Taps', 'Windows', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
