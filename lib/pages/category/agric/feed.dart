...
import 'package:dimand/pages/picloads/feedpic.dart';
...
class _DimpostState extends State<Feeds> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Feeds Supplements and seeds';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new FeedPic()),
    );
