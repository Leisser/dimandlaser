...
import 'package:dimand/pages/picloads/livestockpic.dart';
...
class _DimpostState extends State<Livestock> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  bool _load = false;
  String _bolt = '';
  String category = 'Agriculture & Edibles';
  String subcategory = 'Livestock & Poultry';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new LivesockPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Cane Rats', 'Chickens', 'Chinchillas', 'Cows', 'Ducks', 'Geese', 'Goats', 'Guinea Fouls', 'Pigs', 'Rabbits',
                          'Roosters', 'Sheep', 'Turkey', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
