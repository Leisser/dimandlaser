...
import 'package:dimand/pages/picloads/mealpic.dart';
...
class _DimpostState extends State<Meal> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Meals & Drinks';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new MealPic()),
    );
