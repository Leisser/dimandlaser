...
import 'package:dimand/pages/picloads/heavypic.dart';


class Heavy extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<Heavy> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Heavy Equipments';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new HeavyPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Asphalt Pavers', 'Backhoe Loaders', 'Boom Lift', 'Bulldozers', 'Compactors', 'Compressors', 'Crushers', 'Cranes',
                          'Concrete Mixers', 'Drilling Rigs', 'Dumpers', 'Excavators', 'Farm Machines', 'Graders', 'Helicopters', 'Marsh Machines', 'Loaders',
                          'Pneumatic Rollers', 'Private Jets', 'scissor Lift', 'Storage Tanks', 'Tractors', 'Forklifts', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMake,
                          items: <String>['Atlas Copco', 'Ausa', 'Bobcat', 'Case', 'Caterpillar', 'Clark', 'Dynapac', 'Doosan', 'Demag',
                          'Fiat', 'Ford', 'Foton', 'Grove', 'GMC', 'Hamm', 'Hawker', 'Haib', 'Hyundai', 'Ingersoll Rand', 'JCB', 'JLG',
                          'John Deere', 'Kobelco', 'Komatsu', 'Kubota', 'Liebherr', 'Massey Ferguson', 'Mack Trucks', 'Merlo', 'Manitowoc',
                          'O&K', 'Roadtec', 'Rosco', 'Sany', 'Skyjack', 'Terex', 'Toyota', 'Volvo', 'Vogete', 'Wirtgen', 'Zoomlion', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
