...
import 'package:dimand/pages/picloads/truckpic.dart';
...
class _DimpostState extends State<Trucks> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Trucks & Wagons';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new TruckPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Dumb Trucks', 'Garbage Trucks', 'Low Bed Trucks', 'Rigid Trucks', 'Semi-Trailers', 'Tractor Units', 'Tank Trucks'
                          , 'Trailers', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMake,
                          items: <String>['Changan', 'Chevrolet', 'DAF', 'Dodge', 'ERF', 'Fiat', 'Ford', 'Freightliner', 'GMC', 'Honda', 'Hyundai', 'International',
                          'Isuzu', 'Iveco', 'Kia', 'Man', 'Mack', 'Mazda', 'Mercedes-Benz', 'Mitsubishi', 'Nissan', 'Peugeot', 'Renault',
                          'Scania', 'Suzuki', 'Sinotruck', 'Toyota', 'Volkswagen', 'Volvo', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
