...
import 'package:dimand/pages/picloads/motopick.dart';
...
class _DimpostState extends State<Moto> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cMake, cRegion, cNegotiate;
  bool _load = false;
  String _bolt = '';
  String category = 'Vehicles';
  String subcategory = 'Motocycles & Scooters';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cMake != null && _bolt != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new MotoPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMake,
                          items: <String>['American Ironhorse', 'Aprilia', 'Arctic Cat', 'Autodex', 'BMW', 'BSA', 'Bajaj', 'Beach',
                          'Benelli', 'Big Dog', 'Bimota', 'Boss Hoss', 'Bourget', 'Buell', 'Bultaco', 'Can-Am', 'CFMoto',
                          'CityCoco', 'Cushman', 'Custom Built Motocycles', 'Desperado', 'Ducati', 'EGL', 'Greeves', 'Gilera',
                          'Haojue', 'Harley-Davidson', 'Hodaka', 'Honda', 'Husqvarna', 'Hyosung', 'Indian', 'Jincheng',
                          'Kasea', 'KTM', 'Kary-Go', 'Kawasaki', 'Keeway', 'Kymco', 'Kymstone', 'Lifan',
                          'MV Agusta', 'Mahindra', 'Moto Guzzi', 'Norton', 'Piaggio', 'Peugeot', 'Qlink', 'Sinoki',
                          'Suzuki', 'SYM', 'Titan', 'Tricycle', 'Triumph', 'Ural', 'Vento', 'Victory', 'Vicent', 'Von Dutch',
                          'Yamaha', 'Zongshen', 'Zontes', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
