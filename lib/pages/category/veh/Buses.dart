...
import 'package:dimand/pages/picloads/buspick.dart';
...
class _DimpostState extends State<Buses> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BusPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMake,
                          items: <String>['Toyota', 'Honda', 'Nissan', 'Mercedes-Benz', 'Volkswagen', 'Mitsubishi', 'Peugeot', 'Ford',
                          'Blue Bird', 'Chery', 'Chevrolet', 'Citroen', 'Daewoo', 'Daihatsu', 'Dodge', 'Fiat', 'Foton', 'Freightliner',
                          'GMC', 'Haima', 'Higer', 'Hino', 'Hummer', 'Hyundai', 'Isuzu', 'Iveco', 'IVM', 'JAC', 'Jin Bei', 'Jincheng',
                          'JMC', 'Joylong', 'Kia', 'LDV', 'Lexus', 'Leyland', 'Lifan', 'Mack', 'Mahindra', 'Man', 'Mazda', 'McLaren',
                          'Mercury', 'MG', 'Opel', 'Polaris', 'Pontiac', 'Proton', 'Renault', 'Rover', 'Samsung', 'Sany', 'Saturn',
                          'Scania', 'Seat', 'Simba', 'Skoda', 'SkyGo', 'SMA', 'Smart', 'SsangYong', 'Suzuki', 'Tata', 'T king', 'TVS',
                          'Vector', 'Venturi', 'Volvo', 'Yutong', 'Zhongtong', 'Zoomlion', 'Zotye', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                      return MyDropdown.DropdownMenuItem<String>(
                      value: value,
                      child: Text(value),
