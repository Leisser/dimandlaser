...
import 'package:dimand/pages/picloads/partpic.dart';
...
class _DimpostState extends State<Parts> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cType, cRegion, cNegotiate;
  bool _load = false;
  String _bolt = '';
  String category = 'Vehicles';
  String subcategory = 'Vehicle Parts & Accessories';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new PartPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Air Compressors', 'Auto Key Programmers', 'Alarms', 'Batteries', 'Battery Chargers', 'Brake Pads',
                          'Bumpers', 'Chargers', 'Covers', 'DVD Players', 'Diagnostic Scanners', 'Engine Oils', 'Engines', 'Fog Lights', 'Fuel Pumps',
                          'Fuel Savers', 'Fuel Treatment', 'FM Transmitters', 'Key Holders', 'GPS Trackers', 'GPS Navigators', 'Inspection Mirrors',
                          'Jump Starter Kits', 'Jump Cables', 'Jacks', 'Launch Creaders', 'Mp3 Players', 'Oil Filters', 'Phone Holders', 'Power Steering Fluids',
                          'Power Inverters', 'Pressure Washer Hoses', 'Radios', 'Code Readers', 'Speakers', 'Audio Control Panels', 'Scratch Removers',
                          'Siphon Pumps', 'Spark Plugs', 'Speed Limiter Devices', 'Steering Wheels', 'Tow Ropes',
                          'Transmission Fluids', 'Transporters', 'Tyre Inlators', 'Tyres', 'Vacuum Cleaners', 'Wash Machines', 'Wheels And Rims', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
