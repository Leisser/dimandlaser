...
import 'package:dimand/pages/picloads/groompic.dart';
...
class _DimpostState extends State<Groom> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new GroomPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cShape,
                          items: <String>['Handsome', 'Husky', 'Muscular', 'Rich', 'Slim', 'Solid']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
