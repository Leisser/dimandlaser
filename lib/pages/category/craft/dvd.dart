...
import 'package:dimand/pages/picloads/dvdpic.dart';
...
class _DimpostState extends State<Dvd> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cLanguage, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Hobbies, Art & Sport';
  String subcategory = 'CDs & DVDs';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cLanguage != null && _bolt != null && cType != null) {
      ...
      await prefs.setString('cLanguage',cLanguage);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new DvdPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Audiobooks', 'Movies', 'Music', 'Tutorial', 'Training', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
