...
import 'package:dimand/pages/picloads/campingpic.dart';
...
class _DimpostState extends State<Camping> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cCondition, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Hobbies, Art & Sport';
  String subcategory = 'Camping Gear';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cCondition != null && _bolt != null && cType != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new CampingPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Binoculars', 'Compasses', 'Coocking Supplies', 'Lanterns & Headlamps', 'Furniture', 'Sleeping Bag',
                            'Tents', 'Telescopes', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Select Condition'),
                          value: cCondition,
