...
import 'package:dimand/pages/picloads/musicalpic.dart';
...
class _DimpostState extends State<Musical> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cSubType, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Hobbies, Art & Sport';
  String subcategory = 'Musical Instruments';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cSubType != null && _bolt != null && cType != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new MusicalPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Brass', 'Keyboard Instruments', 'Musical Stands', 'Music Bags & Cases', 'Percussion', 'String Instruments',
                          'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Select Subtype'),
                          value: cSubType,
                          items: <String>['Clarinets', 'Flutes', 'Trambone', 'Trumpets', 'Saxophones', 'Midi Keyboard', 'Organ', 'Piano',
                          'Synthesizer', 'Drum Stands', 'Guitar Stands', 'Keyboard Stands', 'Microphone Stands', 'Sheet Music Stands', 'Acoustic Drum Sets',
                          'Bass Drums', 'Electronic Drum Sets', 'Snare Drums', 'Tamburines', 'Toms', 'Acoustic Guitar', 'Bass Guitar',
                          'Banjo', 'Cello', 'Electric Guitar', 'Harp', 'Ukulele', 'Viola', 'Violin', 'Zither', 'Parts & Accessories']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
