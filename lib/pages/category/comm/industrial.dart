...
import 'package:dimand/pages/picloads/induspic.dart';
...
class _DimpostState extends State<Indus> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cPower, cRegion, cNegotiate, cType, cShape;
  bool _load = false;
  String _bolt = '';
  String category = 'Commercial Equipment & Tools';
  String subcategory = 'Industrial Ovens';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cPower != null && _bolt != null && cType != null && cShape != null) {
      ...
      await prefs.setString('cPower',cPower);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new IndusPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Curing', 'Baking', 'Batch']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Power Source'),
                          value: cPower,
                          items: <String>['Electric', 'Gas']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
