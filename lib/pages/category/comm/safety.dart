...
import 'package:dimand/pages/picloads/safetypic.dart';
...
class _DimpostState extends State<Safety> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cRegion, cNegotiate, dora, pin;
  bool _load = false;
  String _bolt = '';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new SafetyPic()),
    );
                      ...
                      new Container(
                        child: new TextField(
                          decoration: new InputDecoration(
                              hintText: 'Title of the commodity/item',
