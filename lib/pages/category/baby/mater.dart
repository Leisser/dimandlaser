...
import 'package:dimand/pages/picloads/materpic.dart';
...
class _DimpostState extends State<Mater> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Maternity & Pregnancy';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new MaterPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Breast Pumps', 'Breast Pads', 'Dresses', 'Nursing Pillows', 'Nursing Bras', 'Nursing Covers',
                          'Support Belts', 'Tops', 'Trousers', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
