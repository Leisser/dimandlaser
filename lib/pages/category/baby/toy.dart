...
import 'package:dimand/pages/picloads/toypic.dart';
...
class _DimpostState extends State<Toys> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new ToyPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Basketball Hoops', 'Bubble Toys', 'Buses', 'Bouncing Castles', 'Balls', 'Building Blocks',
                          'Balloons', 'Baby Play Mats', 'Bikes', 'Cars', 'Cot Mobiles', 'Dolls', 'Drones', 'Educational', 'Frisbees', 'Guitars',
                          'Fridget Spinners', 'Kids Drums', 'Musical Toys', 'Microphones', 'Laptops', 'Playhouses', 'Pretend Play', 'Puzzels',
                          'Plush Toys', 'Pianos', 'Play Tunnels', 'Playground Equipments', 'Rockers', 'Rattles', 'Rottles', 'Robots', 'Rubic Cube',
                          'Scooters', 'Sliders', 'Tricycles', 'Train', 'Trucks', 'Water Guns']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cGender,
                          items: <String>['Boys', 'Girls','Unisex']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
