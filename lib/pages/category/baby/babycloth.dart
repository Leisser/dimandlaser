...
import 'package:dimand/pages/picloads/babyclothpic.dart';


class BabyCloth extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<BabyCloth> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cGender, cRegion, cNegotiate, cType, cAge;
  bool _load = false;
  String _bolt = '';
  String category = 'Babies & Kids';
  String subcategory = 'Children\'s Clothing';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cGender != null && _bolt != null && cType != null && cAge != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BabyClothPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Boxers', 'Blazers', 'Ballet Dressers', 'Blouses', 'Beanies', 'Body Suits',
                          'Ball Gowns', 'Costumes', 'Caps', 'Cardigans',
                          'Clothing Sets', 'Christening', 'Coats', 'Crayon Dress', 'Dresses', 'Dungarees', 'Jeans',
                          'Jackets', 'Jerseys', 'Jumpsuits', 'Jeggings', 'Leggings', 'Nightwear', 'Overalls',
                          'Polo Shirts', 'Pants', 'Prom Dresses', 'Panties', 'Pantyhose', 'Rompers', 'School Uniforms', 'Shrugs',
                          'Skinny Jeans', 'Swimsuits', 'Skirts', 'Suits', 'Shorts', 'Shirts', 'Singlets',
                          'Sweaters', 'Socks', 'Trousers', 'T-Shirts', 'Tops', 'Underwear', 'Vests', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
