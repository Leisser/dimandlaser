...
import 'package:dimand/pages/picloads/stallerpic.dart';


class Staller extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<Staller> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cBrand, cRegion, cNegotiate, cType, cAge;
  bool _load = false;
  String _bolt = '';
  String category = 'Babies & Kids';
  String subcategory = 'Stallers & Carriers';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cBrand != null && _bolt != null && cType != null && cAge != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new StallerPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Joggers', 'Lightweight', 'Standard', 'Transformable', 'Travel System', 'Tandem']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cBrand,
                          items: <String>['Britax', 'Bugaboo', 'Bumbleride', 'Chico', 'College', 'Combi', 'Contours', 'Evenflo', 'Graco', 'ICandy',
                          'Inglesima', 'InStep', 'Jeep', 'Kolcraft', 'Maclaren', 'Maxi-Cosi', 'Mountain Buggy', 'Mutsy', 'Orbit Baby', 'Peg Perego',
                          'Quinny', 'Schwinn', 'Stokke', 'Valco', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
