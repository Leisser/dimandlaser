...
import 'package:dimand/pages/picloads/childrensafetypic.dart';


class BabySafety extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<BabySafety> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Children\'s Gear & Safety';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BabySafetyPic()),
    );
