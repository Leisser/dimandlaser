...
import 'package:dimand/pages/picloads/babycarepic.dart';
...
class _DimpostState extends State<BabyCare> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BabyCarePic()),
    );
