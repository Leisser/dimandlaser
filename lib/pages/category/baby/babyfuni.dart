...
import 'package:dimand/pages/picloads/babyfunipic.dart';


class BabyFuni extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<BabyFuni > {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cCondition, cRegion, cNegotiate, cType, cAge;
  bool _load = false;
  String _bolt = '';
  String category = 'Babies & Kids';
  String subcategory = 'Children\'s Furniture';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cCondition != null && _bolt != null && cType != null && cAge != null) {
      ...
      await prefs.setString('cCondition',cCondition);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BabyFuniPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Beds', 'Boxes', 'Cabinets', 'Chairs', 'Cots', 'Drawers',
                          'Mattresses', 'Tables', 'Others']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Condtion'),
                          value: cCondition,
