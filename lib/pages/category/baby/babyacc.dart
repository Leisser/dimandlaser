...
import 'package:dimand/pages/picloads/babyaccpic.dart';


class BabyAcc extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<BabyAcc> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Babies & Kids Accessories';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BabyAccPic()),
    );
