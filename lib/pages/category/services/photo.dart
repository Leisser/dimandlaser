...
import 'package:dimand/pages/picloads/photopic.dart';
...
class _DimpostState extends State<Photo> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cInclude, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Services';
  String subcategory = 'Photography & Video Services';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cInclude != null && _bolt != null && cType != null) {
      ...
      await prefs.setString('cInclude',cInclude);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new PhotoPic()),
    );
              ...
              child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Could be more than one'),
                          value: cInclude,
                          items: <String>['Makeup', 'Photo Editing', 'Photo Book', 'Video Editing', 'Non', 'More than one']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
