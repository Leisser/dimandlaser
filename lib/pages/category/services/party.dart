...
import 'package:dimand/pages/picloads/partypic.dart';
...
class _DimpostState extends State<Party> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, cRound, sex, cRegion, cNegotiate;
  bool _load = false;
  String _bolt = '';
  String category = 'Services';
  String subcategory = 'Party, Catering & Event Services';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cRound != null && _bolt != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new PartyPic()),
    );
  ...
  void handleUpdateDim() {
    ...
    if (cName != null && cQuantity != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && _bolt != null && cRound != null) {
      String docName;
