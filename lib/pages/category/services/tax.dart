...
import 'package:dimand/pages/picloads/taxpic.dart';
...
class _DimpostState extends State<Tax> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Tax & Financial Services';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new TaxPic()),
    );
