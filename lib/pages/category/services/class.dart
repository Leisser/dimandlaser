...
import 'package:dimand/pages/picloads/classpic.dart';
...
class _DimpostState extends State<Class> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cDuration, cPrice, cLocation, cDescribe, sex, cSpot, cRegion, cNegotiate, cType, cSubtype, cLevel;
  bool _load = false;
  String _bolt = '';
  String category = 'Services';
  String subcategory = 'Classes & Courses';
  ...
  checkMe() async {
    if (cName != null && cDuration != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && cSpot != null && _bolt != null && cType != null && cSubtype != null && cLevel != null) {
      await prefs.setString('cName', cName);
      await prefs.setString('cDescribe', cDescribe);
      await prefs.setString('cDuration', cDuration);
      ...
      await prefs.setString('cSpot',cSpot);
      await prefs.setString('cType', cType);
      await prefs.setString('cSubtype', cSubtype);
      await prefs.setString('cLevel', cLevel);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new ClassPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Courses', 'Lessons', 'Private Teacher']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Subtype'),
                          value: cSubtype,
                          items: <String>['Academic', 'Business', 'Development', 'Design', 'Health', 'IT & Software', 'Lifestyle', 'Language Learning',
                          'Marketing', 'Music', 'Office Productivity', 'Physical Science & Engeenering', 'Personal Development', 'Photography']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Level'),
                          value: cLevel,
                          items: <String>['Begginer', 'Intermediate', 'Advanced']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Area'),
                          value: cSpot,
                          items: <String>['Distance Learning', 'Home Lessons']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
