...
import 'package:dimand/pages/picloads/logispic.dart';
...
class _DimpostState extends State<Logistic> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cTransport, cPrice, cLocation, cDescribe, sex, cFreigh, cRegion, cNegotiate, cType, cLoading, cPayType;
  bool _load = false;
  String _bolt = '';
  String category = 'Services';
  String subcategory = 'Logistic Services';
  ...
  checkMe() async {
    if (cName != null && cTransport != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && cFreigh != null && _bolt != null && cType != null && cLoading != null && cPayType != null) {
      await prefs.setString('cName', cName);
      await prefs.setString('cDescribe', cDescribe);
      await prefs.setString('cTransport', cTransport);
      ...
      await prefs.setString('cFreigh',cFreigh);
      await prefs.setString('cType', cType);
      await prefs.setString('cLoading', cLoading);
      await prefs.setString('cPayType', cPayType);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new LogisticPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Delivery Services', 'Moving Services']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Is Loading Involved'),
                          value: cLoading,
                          items: <String>['No', 'Loading', 'Loading & Unloading']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Payment Type'),
                          value: cPayType,
                          items: <String>['Hourly', 'By Milaege', 'Piecework']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Fregh Type'),
                          value: cFreigh,
                          items: <String>['Bulk', 'Hazardous','Liguid', 'Live', 'Overall', 'Cars']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose Mode'),
                          value: cTransport,
                          items: <String>['Air', 'Rail', 'Road', 'Maritime']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
