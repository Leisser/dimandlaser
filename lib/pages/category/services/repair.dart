...
import 'package:dimand/pages/picloads/repairpic.dart';
...
class _DimpostState extends State<Repair> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cRound, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Services';
  String subcategory = 'Repair Services';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cRound != null && _bolt != null && cType != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new RepairPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Diagnostics', 'Inspection', 'Installation', 'Repair', 'More Than One']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
