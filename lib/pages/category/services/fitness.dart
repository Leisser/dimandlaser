...
import 'package:dimand/pages/picloads/fitnesspic.dart';
...
class _DimpostState extends State<Fitness> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cAge, cRegion, cNegotiate, cType, cForm, cEqupment;
  bool _load = false;
  String _bolt = '';
  String category = 'Services';
  String subcategory = 'Fitness & Personal Training Services';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cAge != null && _bolt != null && cType != null && cForm != null && cEqupment != null) {
      ...
      await prefs.setString('cForm', cForm);
      await prefs.setString('cEqupment', cEqupment);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new FitnessPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Dance', 'Box', 'Fitness', 'Swimming', 'Yoga']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Form'),
                          value: cForm,
                          items: <String>['Personal', 'Group', 'Corporate']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Equipment'),
                          value: cEqupment,
                          items: <String>['Free', 'Chargeable']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cAge,
                          items: <String>['Adult', 'Kids','Corporate']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
