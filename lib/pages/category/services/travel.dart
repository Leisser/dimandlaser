...
import 'package:dimand/pages/picloads/travelpic.dart';
...
class _DimpostState extends State<Travel> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cDestination, cPrice, cLocation, cDescribe, sex, cDuration, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Services';
  String subcategory = 'Travel & Tour Services';
  ...
  checkMe() async {
    if (cName != null && cDestination != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && cDuration != null && _bolt != null && cType != null) {
      await prefs.setString('cName', cName);
      await prefs.setString('cDescribe', cDescribe);
      await prefs.setString('cDestination', cDestination);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new TravelPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Tours', 'visa', 'Visa & Tours', 'Passport']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose Duratiob'),
                          value: cDuration,
                          items: <String>['Less than 1 month', '1 - 2 month', '2 - 3 month', '3 - 4 moonth', '4 - 5 month', '5 - 6 month', 'More than 6 month']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
