...
import 'package:dimand/pages/picloads/cleaningpic.dart';
...
class _DimpostState extends State<Cleaning> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cRound, cPrice, cLocation, cDescribe, cSpot, sex, cRegion, cNegotiate;
  bool _load = false;
  String _bolt = '';
  String category = 'Health & Beauty';
  String subcategory = 'Bath & Body';
  ...
  checkMe() async {
    if (cName != null && cRound != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && cSpot != null && _bolt != null) {
      await prefs.setString('cName', cName);
      await prefs.setString('cDescribe', cDescribe);
      await prefs.setString('cRound', cRound);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new CleaningPic()),
    );
  ...
  void handleUpdateDim() {
    ...
    if (cName != null && cRound != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && _bolt != null && cSpot != null) {
      String docName;
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new TextField(
                          decoration: new InputDecoration(
                              hintText: 'Title of the commodity',
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cSpot,
                          items: <String>['Commercial', 'Industrial', 'Residential']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Is It Repetitive'),
                          value: cRound,
                          items: <String>['Yes', 'No']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
