...
import 'package:dimand/pages/picloads/lopcompic.dart';


class LopCom extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<LopCom> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Laptops & Computers';
  ...
  Widget clot () {
    if (cType== 'Desktop Computer') {
      return new MyDropdown.DropdownButton(
        hint: new Text('Choose The Brand'),
        value: cBrand,
        items: <String>[
          'Acer', 'Advent', 'Apple', 'Asus', 'Chuwi', 'Dell', 'Digital Storm', 'Fujitsu' ,'Gigabyte' ,'HP' ,'Hasee' ,'i-Life' ,'Lenovo' ,
          'MSI' ,'Novatech' 'Razer' ,'Samsung' ,'Touchmate' ,'Zinox' ,'Zoostorm' ,'Zyrex' ,'Other' ]
      ...
      return new MyDropdown.DropdownButton(
        ...
        value: cBrand,
        items: <String>[
          'Acer' ,'Advent' ,'Alienware' ,'Apple' ,'Asus' ,'Avantis' ,'Avell' ,'Cyberpower' ,'Chuwi' ,'Dell' ,'Digital Storm' ,'eMachines' ,
          'CA' ,'Lapa' ,'CB' ,'CBR' ,'CD' ,'CG' ,'CH' ,'City' ,'Civic' ,'CJ' ,'CL' ,'CM' ,'CN' ,'Concerto' ,'CR' ,'599' ,'Crea' ,
          'Fujitsu' ,'Gateway' ,'Gigabyte' ,'Google' ,'HP' ,'Haier' ,'Hasee' ,'Huawei' ,'i-Life' ,'innjoo' ,'LG' ,'Lenovo' ,'Medion' ,'Metabox' ,
          'MSI' ,'Microsft' ,'NEC' ,'Novatech' ,'Neo' ,'Omatek' ,'Packard Bell' ,'Panasonic' ,'Razer' ,'Samsung' ,'Sager' ,'Sony' ,'Touchmate' ,
          'Toshiba' ,'Vinovo' ,'Waafox' ,'Xiaomi' ,'Yepo' ,'Zinox' ,'Zoostorm' ,'Zyrex' ,'Other']
            .map<MyDropdown.DropdownMenuItem<String>>((String value) {
          return MyDropdown.DropdownMenuItem<String>(
            value: value,
            child: Text(value),
      ...
      return new MyDropdown.DropdownButton(
        hint: new Text('Choose Your Brand'),
        value: cBrand,
        items: <String>[
          'Dell' ,'HP' ,'Other']
            .map<MyDropdown.DropdownMenuItem<String>>((String value) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new LopComPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Desktop Computer', 'Laptop', 'Server']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
