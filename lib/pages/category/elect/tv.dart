...
import 'package:dimand/pages/picloads/tvpic.dart';
...
class _DimpostState extends State<Tv> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'TV & DVD Equipment';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new TvPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Android TV Boxes', 'Antennas', 'Adaptors', 'Blu-Ray Players', 'Cables', 'CCTV DVRs',
                          'Ceiling Mounts', 'Chromecast', 'DVD Players', 'Decoders', 'Guard Protectors', 'Media Players', 'Network Video Recorders',
                          'Projector', 'Projector Stands', 'Remote Controls', 'Remote Control Holders', 'Satellite Dishes', 'TVs Accessories', 'Tuners', 'TVs Receivers',
                          'TVs', 'Video Recorders', 'Wall Mounts', '3D Glasses']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cBrand,
                          items: <String>['Avis', 'Acer', 'Benq', 'Casio', 'Dell', 'Epson', 'Haiser', 'Hisense', 'Hitachi', 'Infocus', 'JVC',
                          'LG', 'Mitsubishi', 'Optoma', 'Panasonic', 'Polystar', 'Philips', 'Samsung', 'Sansui', 'Sanyo', 'Sceptre', 'Seiki', 'Skyrum',
                          'Skyworth', 'Sharp', 'Sony', 'Sunbrite TV', 'Supersonic', 'TCL', 'Toshiba', 'Universal', 'View Sonic', 'VIZIO', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
