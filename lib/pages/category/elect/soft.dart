...
import 'package:dimand/pages/picloads/softpic.dart';
...
class _DimpostState extends State<Soft> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, cPlatform, sex, cRegion, cNegotiate;
  bool _load = false;
  String _bolt = '';
  String category = 'Electronics';
  String subcategory = 'Computer Software';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cPlatform != null && _bolt != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new SoftPic()),
    );
  ...
  void handleUpdateDim() {
    ...
    if (cName != null && cQuantity != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && _bolt != null && cPlatform != null) {
      String docName;
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cPlatform,
                          items: <String>['Windows', 'Mac', 'Linux']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
