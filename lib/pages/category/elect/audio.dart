...
import 'package:dimand/pages/picloads/audiopic.dart';
...
class _DimpostState extends State<Audio> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Audio & Music Equipment';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new AudioPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Amplifiers', 'Audio Cables', 'Audio Interfaces', 'CD Players', 'DJ Controllers', 'DJ Mixers',
                          'Equalizers', 'Flight Cases', 'Headphones', 'Hi-Fi Systems', 'Home Theater System', 'Karaoke', 'Megaphones', 'Microphones',
                          'Midi Controllers', 'Mp3 Players', 'Music Mixers', 'PA Systems', 'Pop Filter', 'Radios', 'Receivers', 'Sound System', 'Soundcards',
                            'Speakers', 'Stage lightings', 'Studio Monitors', 'Turntables', 'Voice Recorders', 'Walkie Talkies', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
