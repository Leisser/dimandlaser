...
import 'package:dimand/pages/picloads/compacpic.dart';


class CompAc extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<CompAc> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cBrand, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Electronics';
  String subcategory = 'Computer Accessories';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cBrand != null && _bolt != null && cType != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new CompAcPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Adaptors', 'Batteries', 'Blank CDs & DVD Disks', 'Cables', 'Cartridges', 'Card Readers',
                          'Chargers', 'Copiers', 'Dongles', 'Flash Drives', 'Gaming Headsets', 'Hdmi Splitters', 'Keyboards',
                          'Laptop Cases', 'Laptop Cooling Pads', 'Laptop Power Banks', 'Laser Toners', 'Media Converters', 'Mice',
                          'Modems', 'Network Cables', 'Network Patch Ponds', 'Patch Cord', 'POS Thermal Printers', 'Presenters',
                          'Printer Drums', 'Printers', 'Scanners', 'Shredders', 'Surge Protectors', 'Switches', 'Tables', 'USB Hubs',
                          'USB Lamps', 'USB VGA Adaptors', 'USB Wi-Fi Adaptors', 'VGA Cables', 'Webcams', 'Wireless Routers', 
                          'Wireless Access Points', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Brand'),
                          value: cBrand,
                          items: <String>['Acer', 'Apple', 'Canon', 'Cisco', 'Crown', 'D-Link', 'Epson', 'Hikvision', 'HP',
                          'Infocus', 'Huawei', 'Genius', 'Logitech', 'Microsoft', 'Optoma', 'Sandisk', 'Spectranet', 'TP-Link',
                          'Universal', 'ZTE', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
