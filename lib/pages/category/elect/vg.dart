...
import 'package:dimand/pages/picloads/vgpic.dart';
...
class _DimpostState extends State<Vg> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cPlatform, cRegion, cNegotiate, cGenre;
  bool _load = false;
  String _bolt = '';
  String category = 'Electronics';
  String subcategory = 'Video Games';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cPlatform != null && _bolt != null && cGenre != null) {
      ...
      await prefs.setString('cPlatform',cPlatform);
      await prefs.setString('cGenre', cGenre);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new VgPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Select Genre'),
                          value: cGenre,
                          items: <String>['Adventure', 'Arcade', 'Action', 'Role Playing', 'Racing', 'Fighting',
                          'Shooter', 'Simulation', 'Strategy', 'Sports', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Platform'),
                          value: cPlatform,
                          items: <String>['Sony Playstation', 'Sony Playstation 2', 'Sony Playstation 3', 'Sony Playstation 4', 'Sony Playstation vita',
                          'Sony PSP', 'Microsoft Xbox', 'Microsoft Xbox one', 'Microsoft Xbox 360', 'PC', 'Nitendo Switch',
                          'Nitendo Wii', 'Nitendo 3DS']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
