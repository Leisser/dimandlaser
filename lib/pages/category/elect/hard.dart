...
import 'package:dimand/pages/picloads/hardpic.dart';
...
class _DimpostState extends State<Hard> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Computer Hardware';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new HardPic()),
    );
