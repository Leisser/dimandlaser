...
import 'package:dimand/pages/picloads/cvapic.dart';
...
class _DimpostState extends State<Camera> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cMake, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Electronics';
  String subcategory = 'Cameras, Video Cameras & Accessories';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cMake != null && _bolt != null && cType != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new CameraPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Adaptors', 'Action Cameras', 'BNC Connectors', 'Battery Grip', 'Batteries And Chargers', 'CCTV Power Suply Boxes',
                          'Cases', 'Camera Stabilizers', 'Camera Straps', 'Cables', 'CCTV Cameras', 'Digital Photo Frames', 'Digital Cameras',
                          'DSLR Shoulder Rigs', 'Drones', 'DSLR Cameras', 'Film Cameras', 'IP Cameras', 'Lenses', 'Light Stands', 'Memory Cards',
                          'Nanny Cams', 'Rent Cameras', 'Ring Lights', 'Photo Studio Umbrella', 'Pal Camcorders', 'Photo Reflectors', 'Spy Cameras',
                          'Spy Camera Pens', 'Splitters', 'Spy Camera Glasses', 'Tripods', 'Video Converters', 'Video Cameras', 'Video Lighting',
                          'Video Confrencing']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMake,
                          items: <String>['Alpa', 'Alpha', 'Axis', 'Bluei', 'Blackmagic', 'Baofeng', 'Canon', 'Cisco', 'Casio', 'Dji', 'Epson',
                          'Easyn', 'Fujifilm', 'GoPro', 'Gigaset', 'Garmin', 'Hasselblad', 'Hikvision', 'HVR', 'Havit', 'HSM', 'Hitachi', 'ION',
                          'JVC', 'Kodak', 'Nikon', 'Ocom', 'Olympus', 'Panasonic', 'Polycom', 'Polaroid', 'Pentax', 'Roland', 'Sony', 'Samsung',
                          'Sigma', 'Sandisk', 'Sharp', 'Seagate', 'Sanyo', 'Universal', 'xtreme', 'Yongnuo', 'Yunteng', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
