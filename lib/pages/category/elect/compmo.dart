...
import 'package:dimand/pages/picloads/compmopic.dart';


class CompMo extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<CompMo> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cSize, cRegion, cNegotiate, cBrand;
  bool _load = false;
  String _bolt = '';
  String category = 'Electronics';
  String subcategory = 'Computer Monitors';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cSize != null && _bolt != null && cBrand != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new CompMoPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cBrand,
                          items: <String>['AOC', 'Apple', 'Aser', 'Asus', 'Benq', 'Dell',
                          'Fujitsu', 'HP', 'Hikvision', 'Lenovo', 'LG', 'Maxview', 'Mercury',
                          'MSI', 'NEC', 'Philips', 'Samsung', 'ViewSonic', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Screen Size'),
                          value: cSize,
                          items: <String>['Larger than 50', '40 - 49.9', '31 - 39.9', '28 - 30.9', '25 - 27.9', '23 - 24.9', '19 - 22.9',
                          '16 - 18.9', 'Less than 16']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
