...
import 'package:dimand/pages/picloads/bagpic.dart';
...
class _DimpostState extends State<Bag> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cGender, cRegion, cNegotiate, cBrand, cMaterial, cColor, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Fashion';
  String subcategory = 'Bags';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BagPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Backpacks', 'Briefcases', 'Card Holders', 'Clutches', 'Handbags', 'Laptop Bags & Cases', 'Lunch Bags',
                          'Pouch Bags', 'School Bags', 'Shoulder Bags', 'Wallets', 'Other',]
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cBrand,
                          items: <String>['Adrienne Vittadini', 'Aldo', 'Alba Handbags', 'Anne Klein', 'Barbara Miliano', 'Bella', 'Betsey Johnson',
                          'Bethelmendels', 'Bonia', 'Braccalini', 'Burberry', 'Calvin Klein', 'Celine', 'Chanel', 'Charles & Kleith', 'Christian Dior', 'Dakine',
                          'David Jones', 'Dizhinge', 'DKNY', 'Dolce & Gabbana', 'Elham', 'Ferrari', 'Fiorelli', 'Givenchy', 'Gucci', 'Guess', 'H & M', 'Hermes', 'Hesey Designs',
                          'Hobo', 'HP', 'Hugo Boss', 'Jansport', 'Jc Cailey', 'Jc Vivian', 'Jing Pin', 'Jelly Kelly', 'Kangaroo', 'Lo & Sons',
                          'louis Vuitton', 'Lucy Box', 'Mango', 'Manolo Blahnik', 'Micheal Kors', 'Miu Miu', 'New Look', 'Ohama', 'Omaya', 'Ospray', 'Philipp Plein', 'Pierre Cardin',
                          'Prada', 'River Island', 'Salvatore Ferragamo', 'Samsonite', 'Sandro Ferrone', 'Sergio Cerruti', 'Scarleton', 'Socko', 'Swiss Polo', 'Swisscross',
                          'Swissgear', 'Targus', 'Tassel', 'Tommy Hilfiger', 'Tovivans', 'Valentino', 'Versace', 'Viviq', 'Victoria Beckham',
                          'Y S L', 'Zannoti', 'Zara', 'Other',]
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMaterial,
                          items: <String>['Cotton', 'Corcluroy', 'Faux Leather', 'Genuine Leather', 'Nylon', 'Polyester', 'Polyurethane', 'Linen', 'Oxford', 'Suede',
                          'Velvet', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
