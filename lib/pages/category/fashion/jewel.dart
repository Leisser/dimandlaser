...
import 'package:dimand/pages/picloads/jewelpic.dart';
...
class _DimpostState extends State<Jewel> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cGender, cRegion, cNegotiate, cStone, cMaterial, cColor, cType;
  bool _load = false;
  String _bolt = '';
  String category = 'Fashion';
  String subcategory = 'Jewelry';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cGender != null && _bolt != null && cStone != null && cMaterial != null && cColor != null
        && cType != null) {
      ...
      await prefs.setString('cStone', cStone);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new JewelPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Bangles', 'Beaded Jewelry', 'Bracelets', 'Brooches', 'Chains', 'Charms', 'Choker Necklaces',
                          'Costume Jewelry', 'Ear Cuffs', 'Earrings', 'Jewelry Boxes', 'Jewelry Sets', 'Necklaces', 'Pendants', 'Rings',
                          'Wristbands','Other',]
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Select Stone'),
                          value: cStone,
                          items: <String>['Alexandrite', 'Amethyst', 'Aquamarine', 'Citrine', 'Diamond', 'Emerald', 'Fancy Diamond',
                          'Garnet', 'Lapis Lazuli', 'Moonstone', 'Morganite', 'Opal', 'Parabia', 'Pearls', 'Peridot', 'Rubellite', 'Ruby',
                          'Rhinestone', 'Sapphire', 'Spinel', 'Tanzanite', 'Topaz', 'Tourmaline', 'Turquoise', 'Zircon', 'Other',]
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cMaterial,
                          items: <String>['Acrylic', 'Cobalt', 'Gold', 'Glass', 'Leather', 'Niobium', 'Nickel', 'Palladium', 'Rhodium', 'Ruthenium',
                          'Silver', 'Stainless Steel', 'Tungsten', 'Titanium', 'Zinc', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
