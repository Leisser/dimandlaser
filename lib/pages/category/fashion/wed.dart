...
import 'package:dimand/pages/picloads/wedpic.dart';


class Wed extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<Wed> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, cGender, sex, cRegion, cNegotiate;
  bool _load = false;
  String _bolt = '';
  String category = 'Fashion';
  String subcategory = 'Wedding Wear';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cGender != null && _bolt != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new WedPic()),
    );
  ...
  void handleUpdateDim() {
    ...
    if (cName != null && cQuantity != null && cPrice != null &&
        cLocation != null && cDescribe != null
        && cNegotiate != null && cRegion != null && _bolt != null && cGender != null) {
      String docName;
