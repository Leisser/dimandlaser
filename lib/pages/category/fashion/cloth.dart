...
import 'package:dimand/pages/picloads/clothpic.dart';
...
class _DimpostState extends State<Cloth> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cGender, cRegion, cNegotiate, cBrand, cSize, cColor, cType;
  bool _load = false;
  String _bolt = '';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cGender != null && _bolt != null && cBrand != null && cSize != null && cColor != null
        && cType != null) {
      ...
      await prefs.setString('cSize', cSize);
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new ClothPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Aso Oke', 'Blazers', 'Blouses', 'Bodysuits', 'Boxers', 'Bra', 'Cardigans',
                          'Coats', 'Dresses', 'Fabrics', 'Hoodies', 'Hosiery', 'Jackets', 'Jeans', 'Jumpsuits', 'Kaftans', 'Leggings', 'Lingeries',
                          'Overalls', 'Pants', 'Playsuits', 'Polo Shirts', 'Pullovers', 'Pyjamas', 'Rompers', 'Sari', 'Shirts', 'Shorts', 'Skirts',
                          'Sleepwears', 'Suits', 'Sweaters', 'Swimsuits', 'Tight', 'Tops', 'Trousers', 'T-Shirts', 'Tunics', 'Turtlenecks',
                          'Tuxedos', 'Underwear', 'Uniforms', 'Vests', 'Waitcoats', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cBrand,
                          items: <String>['Nike' ,'Hermes', 'Louis Vuitton','Cartier', 'Rolex', 'Uniqlo', 'H&M', 'Zara', 'Gucci', 'Adidas', 'Chanel', 
                          'Swarovski', 'Burberry', 'Tom Ford', 'Lululemon', 'The North Face', 'Victoria\'s Secret', 'Prada', 'New Balance', 'Michael Kors', 
                          'Chow Tai Fook', 'Under Armour', 'TJ Maxx', 'Tiffany & Co', 'Coach', 'Foot Locker Inc.', 'Levi\'s', 'C&A', 'Next', 'Chopard', 
                          'Dolce & Gabbana', 'Patek Philippe', 'Moncler', 'Christian Louboutin', 'Omega', 'Ray Ban', 'Salvatore Ferragamo', 'Vera Wang', 'Dior', 
                          'Hugo Boss', 'Armani', 'Nine West', 'Fendi', 'Skechers', 'Old Navy', 'IWC Schaffhausen', 'Primark', 'Max Mara', 'Polo Ralph Lauren', 
                          'Manolo Blahnik', 'Audemars Piguet', 'Diesel', 'Calvin Klein', 'Net-a-Porter', 'Furla', 'GAP', 'Longines', 'Forever 21', 'Steve Madden', 
                          'Stuart Weitzman', 'Urban Outfitters', 'Longchamp', 'Puma', 'Sisley', 'Lao Feng Xiang', 'Tissot', 'Tommy Hilfiger', 'Zalando', 'Nordstrom', 
                          'ASOS', 'Tory Burch', 'Lacoste', 'Topshop', 'G-star', 'Aldo', 'Oakley', 'Cole Haan', 'Jimmy Choo', 'Macy\'s', 'Valentino', 'Elie Taharie', 
                          'Jaeger-Le Coultre', 'Fossil', 'Vacheron Constantin', 'American Eagle Outfitters', 'Elie Saab', 'Patagonia', 'Ted Baker', 'Bogner', 'New Look',
                          'Asics', 'Breguet', 'ESCADA', 'Tag Heuer', 'Banana Republic', 'Desigual', 'Swatch', 'Cavalli', 'Brunello Cucinelli', 'TOD\'s', 'Other',]
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Size'),
                          value: cSize,
                          items: <String>['3XS', 'XXS', 'XS', 'S', 'M', 'L', 'XL', 'XXL', '3XL', '4XL', '5XL', '6XL', '7XL', 'One size']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cColor,
                          items: <String>['Beige', 'Black', 'Brown', 'Blue', 'Gold', 'Gray', 'Green', 'Orange', 'Ivory', 'Multi', 'Pink', 'Purple', 'Red', 'Silver', 'Violet',
                          'White', 'Yellow', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
