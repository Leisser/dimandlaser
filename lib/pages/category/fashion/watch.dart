...
import 'package:dimand/pages/picloads/watchpic.dart';
...
class _DimpostState extends State<Watch> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cGender, cRegion, cNegotiate, cBrand, cCaseMaterial, cBandMaterial, cFeatures, cBandColor, cType, cDisplay, cStyle, cCaseColor;
  bool _load = false;
  String _bolt = '';
  String category = 'Fashion';
  String subcategory = 'Watches';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cGender != null && _bolt != null && cBrand != null && cCaseMaterial != null && cBandColor != null
        && cType != null && cStyle != null && cDisplay != null && cCaseColor != null && cBandMaterial != null && cFeatures != null) {
      ...
      await prefs.setString('cCaseMaterial', cCaseMaterial);
      await prefs.setString('cBandColor', cBandColor);
      await prefs.setString('cType', cType);
      await prefs.setString('cDisplay', cDisplay);
      await prefs.setString('cStyle', cStyle);
      await prefs.setString('cCaseColor', cCaseColor);
      await prefs.setString('cBandMaterial', cBandMaterial);
      await prefs.setString('cFeatures', cFeatures);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new WatchPic()),
    );
      ...
      Firestore.instance.collection('dimandPosts').document(docName).setData(
          {
            ...
            'cBrand': cBrand,
            'cType': cType,
            'cBandmaterial': cBandMaterial,
            'cCaseColor': cCaseColor,
            'cCaseMaterial': cCaseMaterial,
            'cBandColor': cBandColor,
            'cFeatures': cFeatures,
            'cStyle': cStyle,
            'cDisplay': cDisplay,
            'category': category,
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Select Movement'),
                          value: cType,
                          items: <String>['Mechanical', 'Quartz']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cBrand,
                          items: <String>['Patek Philippe', 'Jaeger-LeCoultre', 'Audemars Piguet', 'CARTIER', 'Vacheron Constantin', 'Blancpain',
                            'Glashütte Original', 'Breguet', 'PIAGET', 'Ulysse Nardin', 'Rolex', 'OMEGA', 'IWC', 'Breitling', 'Chopard', 'HUBLOT', 
                            'Panerai', 'BVLGARI', 'ZENITH', 'Carl F. Bucherer', 'Mido', 'Tissot', 'Casio', 'SEIKO', 'Citizen', 'Hamilton', 'TIAN WANG',
                            'Titoni', 'ORIENT', 'FIYTA', 'Swatch', 'CHANEL', 'Hermès', 'Gucci', 'Dior', 'Louis Vuitton', 'Tiffany', 'HUGO BOSS', 'LAVARO',
                          'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cCaseMaterial,
                          items: <String>['Aluminium', 'Ceramic', 'Plastic', 'Titanium', 'Stainless Steel', 'Wood', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cStyle,
                          items: <String>['Business','Casual', 'Sport']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Display'),
                          value: cDisplay,
                          items: <String>['Analog', 'Digital', 'Analog & Digital']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Features'),
                          value: cFeatures,
                          items: <String>['Compass', 'Chronography', 'Calender', 'LED Display', 'Water Resistant']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Material'),
                          value: cBandMaterial,
                          items: <String>['Aluminium', 'Ceramic', 'Faux Leather', 'Genuine Leather', 'Nylon', 'Polyurethane', 'Stainless Steel', 'Wood', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
