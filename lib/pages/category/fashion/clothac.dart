...
import 'package:dimand/pages/picloads/clothacpic.dart';


class ClothAc extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<ClothAc> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Clothing Accessories';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new ClothAcPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Belts', 'Bow Ties', 'Bikinis', 'Glasses', 'Gloves', 'Hat & Caps', 'Headbands',
                          'Mannequins', 'Party Masks', 'Sunglasses', 'Shapewear', 'Socks', 'Ties', 'Turbans', 'Umbrellas', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
