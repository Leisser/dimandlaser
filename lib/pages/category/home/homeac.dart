...
import 'package:dimand/pages/picloads/homeacpic.dart';
...
class _DimpostState extends State<HomeAc> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Home Accessories';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new HomeAcPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['3D Wall Panels', 'Bed Sheets', 'Bedding Sets', 'Bedspreads', 'Blinds', 'Candles',
                          'Chandeliers', 'Cleaning Tools', 'Clocks', 'Curtains', 'Detergents', 'Doormats', 'Duvet', 'Fire Extinguishers',
                          'Flood Lights', 'Landline Phones', 'Laundry Basket', 'Light Bulbs', 'Lighting', 'Mats', 'Mirrors', 'Mop', 'Mosquito Killer',
                          'Mosquito Nets', 'Mosquito Repellent', 'Podlocks', 'Pendant Lights', 'Photo Frames', 'Pillow Cases', 'Rugs', 'Soap Dispensers',
                          'Storage Boxes', 'Throw Pillows', 'Tissue Holders', 'Toothbrush Holders', 'Toothpaste Dispensers', 'Towels', 'Vasels',
                          'Wall Arts', 'Wall Brackets', 'Wall Frames', 'Wall Stickers', 'Wallpaper', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
