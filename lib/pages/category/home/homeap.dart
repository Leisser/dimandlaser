...
import 'package:dimand/pages/picloads/homeappic.dart';


class HomeAp extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<HomeAp> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Home Appliances';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new HomeApPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Alarm Systems', 'Air Coolers', 'Air Conditioners', 'Bathroom Scales', 'Door Phones', 'Door Alarms',
                          'Dehumidifiers', 'Doorbells', 'Drying Racks', 'Fans', 'Fire Alarms', 'Hand Dryers', 'Irons', 'Jacuzzi',
                          'Landline Phones', 'Rechargeable Fans', 'Room Heaters', 'Sewing Machines', 'Smoke Detectors', 'Vaccum Cleaners', 'Washing Machines',
                          'Water Heaters', 'Water Tanks', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
