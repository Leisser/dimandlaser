...
import 'package:dimand/pages/picloads/kitcpic.dart';
...
class _DimpostState extends State<Kitchen> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Kitchen & Dining';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new KitchenPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Aprons', 'Bottle Openers', 'Bowls', 'Cake Stands', 'Chopping Boards', 'Coffee & Tea Cup',
                          'Cooking Knives', 'Cooler Bags', 'Cooling Racks', 'Cup Holders', 'Cutlery Sets', 'Dinner Sets', 'Dish Racks', 'Food Dispensors',
                          'Food Flasks', 'Fruits Baskets', 'Frying Pans', 'Graters', 'Kitchen Slicers', 'Kitchen Utensils', 'Lunch Boxes & Totes',
                          'Mugs', 'Napkins', 'Oven Mitts & Pot Holders', 'Plate Racks', 'Potato Chippers', 'Pots & Pans', 'Pressure Cookers',
                          'Spice Racks', 'Spoons', 'Storage Containers', 'Storage Jars', 'Storage Racks', 'Colanders', 'Toothpick Holders',
                            'Trays', 'Vegetable Choppers', 'Water Bottles', 'Wine Glasses', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
