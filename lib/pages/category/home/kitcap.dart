...
import 'package:dimand/pages/picloads/kitcappic.dart';


class KitchenAp extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<KitchenAp> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cColor, cRegion, cNegotiate, cType;
  bool _load = false;
  String _bolt = '';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cColor != null && _bolt != null && cType != null) {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new KitchenApPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Blenders', 'Bread Makers', 'Cookers', 'Chest Freezers', 'Cooktops', 'Chafing Dishes',
                          'Coffee Machines', 'Deep Fryers', 'Dishwashers', 'Egg Cookers', 'Food Steamers', 'Food Thermometers', 'Food Processors',
                          'Food Warmers', 'Food Grinders', 'Grills & Outdoor Cooking', 'Gas Cylinders', 'Gas Lighters', 'Hobs', 'Hot Plates', 'Ice Cream Makers',
                          'Ice Makers', 'Juicers', 'Knife Sharpeners', 'Kettles', 'Meat Grinders', 'Microwaves', 'Mixers',
                          'Ovens', 'Popcon Makers', 'Pancake Makers', 'Range Hoods', 'Rice Cookers', 'Refrigrators', 'Sandwich Makers', 'Shawarma Machines',
                          'Shawarma Toasters', 'Spice Grinders', 'Thermo Pots', 'Toasters', 'Water Dispensers', 'Water Filters', 'Waffle Irons',
                          'Yam Pounders', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
