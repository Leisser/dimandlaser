...
import 'package:dimand/pages/picloads/hairpic.dart';
...
class _DimpostState extends State<Hair> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Hair Beauty';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new HairPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Conditioners', 'Creams', 'Hair Dye', 'Hair Spray', 'Hair Soap', 'Hair Mousse', 'Hair Serums',
                          'Hair Steamer Caps', 'Hair Oil', 'Shampoos', 'Styling Gel', 'Wig Clips', 'Wig Caps', 'Wigs']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
