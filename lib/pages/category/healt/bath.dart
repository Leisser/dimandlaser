...
import 'package:dimand/pages/picloads/bathpic.dart';
...
class _DimpostState extends State<Bath> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new BathPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Antiseptics', 'Body Oils', 'Body Scrubs', 'Body Sprays', 'Body Butter', 'Body Cream', 'Dental Floss',
                          'Deodorant & Aniperspirant', 'Panty Liner', 'Scales', 'Shower Gels', 'Bath Salt', 'Soap', 'Teeth Whitening',
                          'Toothbrushes', 'Toothpaste','Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
