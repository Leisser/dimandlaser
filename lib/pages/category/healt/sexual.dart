...
import 'package:dimand/pages/picloads/sexualpic.dart';
...
class _DimpostState extends State<Sexual> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String subcategory = 'Sexual Wellness';
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new SexualPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Adult Toys', 'Body Enhancing Devices', 'Condoms & Contraceptives', 'Fertility Supplements', 'Lubricants',
                          'Massage Cream & Oils', 'Sexual Suplements']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
