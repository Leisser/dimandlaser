...
import 'package:dimand/pages/picloads/skinpic.dart';
...
class _DimpostState extends State<Skin> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cGender, cRegion, cNegotiate, cType, cSkinType, cBenefits;
  bool _load = false;
  String _bolt = '';
  String category = 'Health & Beauty';
  String subcategory = 'Skin Care';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cGender != null && _bolt != null && cType != null && cSkinType != null && cBenefits != null) {
      ...
      await prefs.setString('cSkinType', cSkinType);
      await prefs.setString('cBenefits', cBenefits);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new SkinPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Body Milk', 'Cleaners & Toners', 'Creams', 'Skin Oils', 'Scrubs & Masks']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Skin Type'),
                          value: cSkinType,
                          items: <String>['Combination', 'Dry', 'Fatigue', 'Normal', 'Oily', 'Senstive', 'All Skin Types']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Benefits'),
                          value: cBenefits,
                          items: <String>['Anti-Aging', 'Acne Treatment', 'Caring', 'Hydrating', 'Illuminating', 'Moisturizing', 'Oil-Control',
                          'Purifying', 'Radiance', 'Sun Protecting', 'Spots Removal', 'Whitening']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
