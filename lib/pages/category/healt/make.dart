...
import 'package:dimand/pages/picloads/makepic.dart';
...
class _DimpostState extends State<Make> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cGender, cRegion, cNegotiate, cType, cColour, cTone;
  bool _load = false;
  String _bolt = '';
  String category = 'Health & Beauty';
  String subcategory = 'Makeup';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cGender != null && _bolt != null && cType != null && cColour != null && cTone != null) {
      ...
      await prefs.setString('cColour', cColour);
      await prefs.setString('cTone', cTone);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new MakePic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Brushes', 'Concealers', 'False Eyelashes & Adhesives', 'Lipsticks', 'Lip Glosses', 'Liners', 'Mascaras',
                          'Makeup Sets', 'Pencils', 'Powders', 'Primers', 'Removers', 'Setting Spray', 'Ssponges', 'Other',]
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cColour,
                          items: <String>['Beige', 'Black', 'Blonde', 'Blue', 'Brown', 'Caramel', 'Chocolate', 'Ebony', 'Gold', 'Gray', 'Green', 'Ivory',
                          'Orange', 'Pink', 'Purple', 'Red', 'Silver', 'Violet', 'White', 'Yellow', 'Multi', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
