...
import 'package:dimand/pages/picloads/skinvpic.dart';


class SkinV extends StatefulWidget {
  @override
  _DimpostState createState() => _DimpostState();
}

class _DimpostState extends State<SkinV> {
  @override
...
class DimPostScreenState extends State<DimPostScreen> {
  ...
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cDescribe, sex, cAge, cRegion, cNegotiate, cType, cFormular, cPackage;
  bool _load = false;
  String _bolt = '';
  String category = 'Health & Beauty';
  String subcategory = 'Vitamins & Supplements';
  ...
  checkMe() async {
    if (cName != null && cQuantity != null && cPrice != null &&
        ...
        && cNegotiate != null && cRegion != null && cAge != null && _bolt != null && cType != null && cFormular != null && cPackage != null) {
      ...
      await prefs.setString('cPackage', cPackage);
      await pickOn();
    } else {
  ...
  Future<void> pickOn() async {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => new SkinVPic()),
    );
                    ...
                    children: <Widget>[
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cType,
                          items: <String>['Arthritis Supplements', 'Anti Aging Supplements', 'Beauty Supplements', 'Blood Supplements', 'Diabetic Supplements',
                          'Detox Cleaners', 'Energy Boosters', 'Eye Supplements', 'Fat Acids', 'Heart Supplements', 'Immune System Boosters', 'Minerals', 'Protein',
                          'Vitamins', 'Weight Loss Products', 'Other']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          ...
                          value: cFormular,
                          items: <String>['Capsule', 'Cream', 'Drink', 'Drops', 'Gel', 'Gummy', 'Liguid', 'Pills', 'Powder', 'Tablets']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Package'),
                          value: cPackage,
                          items: <String>['Bottle', 'Canister', 'Pouch', 'Plastic Container', 'Paper Box', 'Stick', 'Zip pack']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
                      ...
                      new Container(
                        child: new MyDropdown.DropdownButton(
                          hint: new Text('Choose the Age Group'),
                          value: cAge,
                          items: <String>['Adult', 'Baby','Children']
                              .map<MyDropdown.DropdownMenuItem<String>>((String value) {
                            return MyDropdown.DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
