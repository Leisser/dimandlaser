...
class FitnessPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<FitnessPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cAge, cRegion, cNegotiate, cType, cForm, cEqupment;
  ...
  Future<void> readLocal() async {
    ...
    cForm = prefs.getString('cForm') ?? '';
    cType = prefs.getString('cType') ?? '';
    cEqupment = prefs.getString('cEqupment') ?? '';
