...
class TravelPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<TravelPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cDestination, cPrice, cLocation, cLead, cDescribe, sex, cType, cDuration, cRegion, cNegotiate;
  ...
  Future<void> readLocal() async {
    ...
    cDestination = prefs.getString('cDestination') ?? '';
  ...
  Future<List<String>> uploadImage(
    ...
    await prefs.setString('cDestination', null);
