...
class FragrancePic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<FragrancePic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cGender, cRegion, cNegotiate, cBrand, cScent, cFormular;
  ...
  Future<void> readLocal() async {
    ...
    cScent = prefs.getString('cScent') ?? '';
    cBrand = prefs.getString('cBrand') ?? '';
    cFormular = prefs.getString('cFormular') ?? '';
