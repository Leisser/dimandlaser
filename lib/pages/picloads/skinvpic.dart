...
class SkinVPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<SkinVPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cAge, cRegion, cNegotiate, cType, cFormular, cPackage;
  ...
  Future<void> readLocal() async {
    ...
    cPackage = prefs.getString('cPackage') ?? '';
