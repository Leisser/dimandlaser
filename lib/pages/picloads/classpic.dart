...
class ClassPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<ClassPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cDuration, cPrice, cLocation, cLead, cDescribe, sex, cSpot, cRegion, cNegotiate, cType, cSubtype, cLevel;
  ...
  Future<void> readLocal() async {
    ...
    cDuration = prefs.getString('cDuration') ?? '';
    ...
    cSpot = prefs.getString('cSpot') ?? '';
    cSubtype = prefs.getString('cSubtype') ?? '';
    cType = prefs.getString('cType') ?? '';
    cLevel = prefs.getString('cLevel') ?? '';
  ...
  Future<List<String>> uploadImage(
    ...
    await prefs.setString('cDuration', null);
