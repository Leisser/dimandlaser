...
class CarPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<CarPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cMake, cRegion, cNegotiate, cModel, cTransmission;
  ...
  Future<void> readLocal() async {
    ...
    cMake = prefs.getString('cMake') ?? '';
    cModel = prefs.getString('cModel') ?? '';
    cTransmission = prefs.getString('cTransmission') ?? '';
