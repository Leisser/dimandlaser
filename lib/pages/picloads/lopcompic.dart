...
class LopComPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<LopComPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cBrand, cRegion, cNegotiate, cType;
