...
class LandPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<LandPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cSquareM, cRegion, cNegotiate, cType;
  ...
  Future<void> readLocal() async {
    ...
    cSquareM = prefs.getString('cSquareM') ?? '';
