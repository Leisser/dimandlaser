...
class BabyShoePic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<BabyShoePic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cGender, cRegion, cNegotiate, cType, cSize;
