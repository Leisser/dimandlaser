...
class HouseAprPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<HouseAprPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cFurnish, cRegion, cNegotiate, cType, cParking, cRooms, cBedroom, cBathroom;
  ...
  Future<void> readLocal() async {
    ...
    cFurnish = prefs.getString('cFurnish') ?? '';
    cParking = prefs.getString('cParking') ?? '';
    cType = prefs.getString('cType') ?? '';
    subcategory = prefs.getString('dora') ?? '';
    cRooms = prefs.getString('cRooms') ?? '';
    cBedroom = prefs.getString('cBedroom') ?? '';
    cBathroom = prefs.getString('cBathroom') ?? '';
