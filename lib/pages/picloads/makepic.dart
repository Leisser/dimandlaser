...
class DoAppState extends State<MakePic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cGender, cRegion, cNegotiate, cType, cColour, cTone;
  ...
  Future<void> readLocal() async {
    ...
    cColour = prefs.getString('cColour') ?? '';
    cType = prefs.getString('cType') ?? '';
    cTone = prefs.getString('cTone') ?? '';
