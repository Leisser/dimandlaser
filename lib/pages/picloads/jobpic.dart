...
class JobPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<JobPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cRequirement, cLocation, cLead, cDescribe, sex, cExperience, cRegion, cCareer, cType, cSalary;
  ...
  Future<void> readLocal() async {
    ...
    cRequirement = prefs.getString('cRequirement') ?? '';
    cRegion = prefs.getString('cRegion') ?? '';
    cCareer = prefs.getString('cCareer') ?? '';
    cExperience = prefs.getString('cExperience') ?? '';
    cSalary = prefs.getString('cSalary') ?? '';
  ...
  Future<List<String>> uploadImage(
    ...
    await prefs.setString('cRequirement', null);
    dim();
