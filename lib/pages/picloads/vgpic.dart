...
class VgPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<VgPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cPlatform, cRegion, cNegotiate, cGenre;
  ...
  Future<void> readLocal() async {
    ...
    cPlatform = prefs.getString('cPlatform') ?? '';
    cGenre = prefs.getString('cGenre') ?? '';
