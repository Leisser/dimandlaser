...
class LogisticPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<LogisticPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cTransport, cPrice, cLocation, cLead, cDescribe, sex, cFreigh, cRegion, cNegotiate, cType, cLoading, cPayType;
  ...
  Future<void> readLocal() async {
    ...
    cTransport = prefs.getString('cTransport') ?? '';
    ...
    cFreigh = prefs.getString('cFreigh') ?? '';
    cLoading = prefs.getString('cLoading') ?? '';
    cType = prefs.getString('cType') ?? '';
    cPayType = prefs.getString('cPayType') ?? '';
  ...
  Future<List<String>> uploadImage(
    ...
    await prefs.setString('cTransport', null);
