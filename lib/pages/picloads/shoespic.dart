...
class ShoePic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<ShoePic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cGender, cRegion, cNegotiate, cBrand, cMaterial, cColor, cType, cFastening, cStyle;
  ...
  Future<void> readLocal() async {
    ...
    cMaterial = prefs.getString('cMaterial') ?? '';
    cBrand = prefs.getString('cBrand') ?? '';
    cColor = prefs.getString('cColor') ?? '';
    cType = prefs.getString('cType') ?? '';
    cFastening = prefs.getString('cFastening') ?? '';
