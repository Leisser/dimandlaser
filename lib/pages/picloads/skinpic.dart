...
class SkinPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<SkinPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cGender, cRegion, cNegotiate, cType, cSkinType, cBenefits;
  ...
  Future<void> readLocal() async {
    ...
    cSkinType = prefs.getString('cSkinType') ?? '';
    cType = prefs.getString('cType') ?? '';
    cBenefits = prefs.getString('cBenefits') ?? '';
