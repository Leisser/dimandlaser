...
class WatchPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<WatchPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cGender, cRegion, cNegotiate, cBrand, cCaseMaterial, cBandMaterial, cFeatures, cBandColor, cType, cDisplay, cStyle, cCaseColor;
  ...
  Future<void> readLocal() async {
    ...
    cCaseMaterial = prefs.getString('cCaseMaterial') ?? '';
    cBrand = prefs.getString('cBrand') ?? '';
    cBandColor = prefs.getString('cBandColor') ?? '';
    cFeatures = prefs.getString('cFeatures') ?? '';
    cType = prefs.getString('cType') ?? '';
    cDisplay = prefs.getString('cDisplay') ?? '';
    cStyle = prefs.getString('cStyle') ?? '';
    cCaseColor = prefs.getString('cCaseColor') ?? '';
    cBandMaterial = prefs.getString('cBandMaterial') ?? '';
