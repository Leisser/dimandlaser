...
class CampingPic extends StatefulWidget {
  @override
  DoAppState createState() => new DoAppState();
}

class DoAppState extends State<CampingPic> {
  List<Asset> images = List<Asset>();
  String uploadUrls;
  SharedPreferences prefs;
  String cName, id, photoUrl, nickName, country, phoneNumber, address,
      cQuantity, cPrice, cLocation, cLead, cDescribe, sex, cCondition, cRegion, cNegotiate;
  ...
  Future<void> readLocal() async {
    ...
    cCondition = prefs.getString('cCondition') ?? '';
